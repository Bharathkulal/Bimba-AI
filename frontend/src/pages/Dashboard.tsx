...
export const Dashboard: React.FC = () => {
  ...
  return (
    <div className={`flex flex-col gap-6 text-left w-full max-w-[1440px] mx-auto px-4 py-6 transition-all duration-300 ease-in-out relative ${isDark ? 'bg-transparent' : 'bg-[#F8F8F8]'}`}>
      ...
      {isDark && (
        <>
          <div className="fixed top-0 left-0 w-[600px] h-[600px] rounded-full pointer-events-none" style={{ background: 'radial-gradient(circle, rgba(16,185,129,0.04) 0%, transparent 70%)' }} />
          <div className="fixed bottom-0 right-0 w-[500px] h-[500px] rounded-full pointer-events-none" style={{ background: 'radial-gradient(circle, rgba(16,185,129,0.03) 0%, transparent 70%)' }} />
        </>
      )}
      ...
      {isUploading && (
        <div className="fixed inset-0 bg-[#111111]/30 dark:bg-black/60 backdrop-blur-md z-50 flex items-center justify-center p-6 transition-all duration-300">
          <div className="bg-[#FFFFFF] dark:bg-[#1F2937] border border-[#E5E7EB] dark:border-white/10 p-6 rounded-3xl max-w-md w-full shadow-lg flex flex-col items-center gap-4 text-center animate-scale transition-colors duration-300">
            <div className="w-12 h-12 border-4 border-[#111111] dark:border-[#10B981] border-t-transparent rounded-full animate-spin" />
      ...
      <section 
        style={isDark ? { background: 'linear-gradient(135deg, rgba(16,185,129,0.18), rgba(16,185,129,0.05), rgba(255,255,255,0.02))', boxShadow: '0 10px 40px rgba(0,0,0,0.35)' } : {}}
        className={`border rounded-[20px] p-8 flex flex-col md:flex-row items-center justify-between gap-6 relative overflow-hidden transition-all duration-300 ${
          isDark 
      ...
      >
        <div className="flex-1 text-left relative z-10">
          <span className={`text-xs font-bold uppercase tracking-wider px-2.5 py-1 rounded-full mb-3 inline-block transition-colors duration-300 ${
            isDark ? 'text-[#10B981] bg-[#10B981]/10 border border-emerald-500/10' : 'text-slate-900 bg-[#F3F4F6]'
          }`}>Welcome Back</span>
          ...
          <div className="flex flex-wrap gap-3 mt-6">
            <button 
              ...
              className={`font-bold py-2.5 px-5 rounded-[14px] flex items-center gap-2 cursor-pointer shadow-sm transition-all duration-250 btn-glow-green ${
                isDark 
                  ? 'bg-[#10B981] hover:bg-[#34D399] text-white shadow-emerald-500/10' 
            ...
            <button 
              ...
              className={`font-semibold py-2.5 px-5 rounded-[14px] cursor-pointer transition-all duration-250 ${
                isDark 
        ...
        <div className={`hidden lg:flex items-center justify-center shrink-0 w-48 h-48 rounded-2xl relative transition-all duration-300 ${
          isDark ? 'bg-emerald-950/10 border border-emerald-500/15 shadow-[0_0_30px_rgba(16,185,129,0.05)]' : 'bg-gradient-to-tr from-slate-50 to-slate-100/50 border border-slate-100'
        }`}>
          ...
          <div className="flex flex-col gap-2 w-32 bg-white dark:bg-[#111827] border border-slate-200 dark:border-white/10 p-4 rounded-xl shadow-lg transform rotate-6 hover:rotate-0 transition-transform duration-300">
            ...
            <div className="w-full h-1.5 bg-[#10B981]/15 rounded mt-1" />
          </div>
        </div>
      </section>
      ...
      <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {/* Card 1: Resume Score */}
        <div className={`border rounded-[20px] p-6 flex items-center justify-between hover:-translate-y-1 transition-all duration-300 ${
          isDark ? 'bg-[rgba(31,41,55,0.75)] backdrop-blur-[18px] border-white/[0.08] shadow-[0_10px_40px_rgba(0,0,0,0.35)] hover:border-white/[0.15]' : 'bg-[#FFFFFF] border-[#E5E7EB] shadow-sm hover:shadow-md'
        }`}>
          <div className="text-left">
            ...
            <span className={`text-xs font-medium mt-1 block flex items-center gap-0.5 transition-colors duration-300 ${isDark ? 'text-[#34D399]' : 'text-slate-900'}`}>
              <span className="font-bold">↑ 2.4%</span> vs last week
            </span>
          </div>
          <div className={`w-14 h-14 rounded-full flex items-center justify-center shrink-0 border transition-all duration-300 ${
            isDark ? 'bg-[#10B981]/15 text-[#34D399] border-emerald-500/20' : 'bg-[#F3F4F6] text-slate-900 border-[#E5E7EB]'
          }`}>
            <Award size={22} />
          </div>
        </div>
      ...
      <section className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
        ...
        <div className="lg:col-span-2">
          <div className={`border rounded-[20px] p-6 transition-all duration-300 ${
            isDark ? 'bg-[rgba(31,41,55,0.75)] backdrop-blur-[18px] border-white/[0.08] shadow-[0_10px_40px_rgba(0,0,0,0.35)] hover:border-white/[0.15]' : 'bg-[#FFFFFF] border-[#E5E7EB] shadow-sm hover:shadow-md'
          }`}>
            <div className="flex justify-between items-center mb-6">
              ...
              <span className={`text-xs font-bold px-2.5 py-1 rounded-full border transition-colors duration-300 ${
                isDark ? 'text-[#10B981] bg-[#10B981]/10 border-emerald-500/20' : 'text-slate-900 bg-[#FFFFFF] border-[#111111]'
              }`}>Live & Ready</span>
            </div>
            ...
            {bestResume ? (
              <div className="flex flex-col gap-6">
                ...
                <div className={`flex flex-col md:flex-row gap-4 p-5 rounded-2xl border transition-colors duration-300 ${
                  isDark ? 'bg-[#111827] border-white/5' : 'bg-[#F8F8F8] border-[#E5E7EB]'
                }`}>
                  ...
                  <div className="w-full md:w-32 bg-white dark:bg-[#1F2937] border border-slate-200 dark:border-white/10 rounded-lg p-3 shrink-0 flex flex-col gap-2">
                    <div className="w-10 h-1.5 bg-[#10B981] rounded" />
                  ...
                  <div className="flex-1 flex flex-col justify-between">
                    ...
                    <div className="flex items-center gap-3 mt-3">
                      <span className={`text-sm font-bold bg-white border px-3 py-1.5 rounded-lg shadow-sm transition-all duration-300 ${
                        isDark ? 'bg-[#1F2937] border-white/10 text-white' : 'bg-white border-[#E5E7EB] text-slate-900'
                      }`}>
                        ATS Score: {bestResume.atsScore || 75}%
                      </span>
                      <span className={`text-sm font-bold border px-3 py-1.5 rounded-lg transition-colors duration-300 ${
                        isDark ? 'bg-[#10B981]/10 border-emerald-500/20 text-[#34D399]' : 'bg-[#F3F4F6] border-[#E5E7EB] text-slate-900'
                      }`}>
                ...
                <div className="w-full">
                  ...
                  <div className="w-full bg-[#E5E7EB] dark:bg-white/10 h-2.5 rounded-full overflow-hidden">
                    <div 
                      className={`h-full rounded-full transition-all duration-550 ${isDark ? 'bg-[#10B981]' : 'bg-[#111111]'}`} 
                ...
                <div className="flex flex-wrap gap-3 pt-2">
                  <button 
                    ...
                    className={`font-bold py-2 px-4 rounded-[14px] flex items-center gap-1.5 cursor-pointer text-sm transition-all duration-200 btn-glow-green ${
                      isDark 
                        ? 'bg-[#10B981] hover:bg-[#34D399] text-white shadow-sm' 
                        : 'bg-[#111111] hover:bg-[#000000] text-[#FFFFFF]'
                    }`}
                  >
                  ...
                  <button 
                    onClick={() => navigate(`/resume-builder?id=${bestResume.id}`)}
                    className={`font-semibold py-2 px-4 rounded-[14px] cursor-pointer text-sm flex items-center gap-1.5 transition-all duration-200 ${
                      isDark 
              ...
              <div className={`flex flex-col items-center justify-center py-10 border border-dashed rounded-2xl transition-colors duration-300 ${
                isDark ? 'bg-[#111827] border-white/10' : 'bg-[#F8F8F8] border-[#E5E7EB]'
              }`}>
                ...
                <button 
                  ...
                  className={`font-bold py-2 px-4 rounded-[14px] mt-4 cursor-pointer text-xs transition-all duration-200 ${
                    isDark ? 'bg-[#10B981] hover:bg-[#34D399] text-white' : 'bg-[#111111] hover:bg-[#000000] text-[#FFFFFF]'
                  }`}
                >
          ...
          <div className={`border rounded-[20px] p-6 transition-all duration-300 ${
            ...
            <div className="flex flex-col gap-3 mb-5 border-b border-slate-100 dark:border-white/5 pb-4">
              <div className="flex gap-2.5 items-start text-xs">
                <div className="w-6 h-6 rounded-full bg-[#10B981] text-white flex items-center justify-center text-[10px] shrink-0 font-extrabold">AI</div>
            ...
            <div className="flex flex-col gap-2.5">
              <button 
                ...
                className={`w-full text-left p-3.5 border rounded-xl cursor-pointer transition-all flex items-center justify-between text-xs font-bold ${
                  isDark 
                    ? 'border-white/10 hover:border-[#10B981] hover:bg-white/5 text-white' 
      ...
      <section className={`border rounded-[20px] p-6 transition-all duration-300 ${
        isDark ? 'bg-[rgba(31,41,55,0.75)] backdrop-blur-[18px] border-white/[0.08] shadow-[0_10px_40px_rgba(0,0,0,0.35)] hover:border-white/[0.15]' : 'bg-[#FFFFFF] border-[#E5E7EB] shadow-sm hover:shadow-md'
      }`}>
        <div className={`flex justify-between items-center mb-6 border-b pb-2 transition-colors duration-300 ${
          ...
          <button 
            onClick={() => navigate('/jobs')}
            className={`text-xs font-bold hover:underline flex items-center gap-0.5 cursor-pointer bg-transparent border-0 transition-colors duration-300 ${
              isDark ? 'text-[#34D399]' : 'text-slate-900'
            }`}
          >
        ...
        <div className="flex flex-col gap-4">
          {latestJobs.length === 0 ? (
            <div className={`text-center py-10 border border-dashed rounded-2xl text-xs font-semibold transition-colors duration-300 ${
              isDark ? 'bg-[#111827] border-white/10 text-[#9CA3AF]' : 'bg-[#F8F8F8] border-[#E5E7EB] text-[#9CA3AF]'
            }`}>
            ...
            latestJobs.slice(0, 3).map((job) => (
              <div 
                key={job.id}
                className={`flex flex-col md:flex-row items-start md:items-center justify-between p-4 border rounded-2xl transition-all duration-300 gap-4 ${
                  isDark ? 'border-white/5 hover:border-[#10B981]' : 'border-[#E5E7EB] hover:border-[#111111]'
                }`}
              >
                <div className="flex items-center gap-4 text-left">
                  {job.logo ? (
                    <img 
                      src={job.logo} 
                      alt={job.company} 
                      className={`w-12 h-12 rounded-xl object-cover border shrink-0 transition-colors duration-300 ${
                    ...
                    <div className={`w-12 h-12 rounded-xl border flex items-center justify-center shrink-0 transition-colors duration-300 ${
                      isDark ? 'bg-[#111827] border-white/10 text-[#34D399]' : 'bg-[#F3F4F6] border-[#E5E7EB] text-slate-900'
                    }`}>
                      <Building size={20} />
                    </div>
                  )}
                ...
                <div className="flex items-center flex-wrap gap-4 w-full md:w-auto justify-between md:justify-end border-t border-slate-50 md:border-t-0 pt-3 md:pt-0 dark:border-white/5">
                  <div className="flex items-center gap-3">
                    <span className={`text-xs font-bold border px-2.5 py-1 rounded-lg transition-colors duration-300 ${
                      isDark ? 'bg-[#111827] border-white/10 text-[#D1D5DB]' : 'bg-[#F8F8F8] border-[#E5E7EB] text-[#6B7280]'
                    }`}>
                      {job.salary || 'Competitive'}
                    </span>
                    <span className={`text-xs font-bold border px-2.5 py-1 rounded-lg transition-colors duration-300 ${
                      isDark ? 'bg-transparent border-[#10B981] text-[#34D399]' : 'bg-white border-[#111111] text-slate-900'
                    }`}>
                  ...
                  <button 
                    ...
                    className={`font-bold py-2 px-4 rounded-[14px] text-xs cursor-pointer transition-all duration-200 btn-glow-green ${
                      isDark 
                        ? 'bg-[#10B981] hover:bg-[#34D399] text-white shadow-sm' 
                        : 'bg-[#111111] hover:bg-[#000000] text-[#FFFFFF]'
                    }`}
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className={`border rounded-[20px] p-6 transition-all duration-300 ${
          ...
          <h3 className={`text-base font-bold mb-4 border-b pb-2 transition-colors duration-300 ${
            isDark ? 'border-white/10 text-white' : 'border-[#F1F5F9] text-slate-900'
          }`}>
            Timeline Actions
          </h3>
          <div className="flex flex-col gap-4">
            {activities.length === 0 ? (
              ...
              activities.slice(0, 4).map((act, index) => (
                <div key={index} className="flex gap-3 text-left items-start text-xs">
                  <div className={`w-2 h-2 rounded-full mt-1.5 shrink-0 transition-colors duration-300 ${isDark ? 'bg-[#10B981]' : 'bg-[#111111]'}`} />
                  <div>
        ...
        <div className={`border rounded-[20px] p-6 transition-all duration-300 ${
          ...
          <div className="grid grid-cols-2 gap-4">
            <button 
              ...
              className={`flex flex-col items-center justify-center gap-2 p-5 rounded-2xl border cursor-pointer transition-all duration-300 ${
                isDark 
                  ? 'border-white/10 hover:border-[#10B981] hover:bg-[#111827]' 
            ...
            >
              <div className={`w-10 h-10 rounded-xl flex items-center justify-center border transition-colors duration-300 ${
                isDark ? 'bg-[#10B981]/10 text-[#34D399] border-emerald-500/20' : 'bg-[#F3F4F6] text-slate-900 border-[#E5E7EB]'
              }`}>
                <UploadCloud size={20} />
              </div>
