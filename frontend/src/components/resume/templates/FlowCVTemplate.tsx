  ...
  return (
    <div className="p-8 bg-white text-[#2D3748] max-w-[800px] mx-auto text-left font-sans leading-normal">
      ...
      {data.certifications && data.certifications.length > 0 && (
        <div className="mb-5">
          <h3 className="text-xs font-extrabold uppercase tracking-widest text-[#4A5568] border-b border-slate-100 pb-1 mb-2">Certifications</h3>
          <div className="space-y-2">
      ...
      {data.portfolioLinks && data.portfolioLinks.length > 0 && (
        <div className="mb-5">
          <h3 className="text-xs font-extrabold uppercase tracking-widest text-[#4A5568] border-b border-slate-100 pb-1 mb-2">Portfolio</h3>
          <p className="text-[10.5px] text-slate-650 leading-relaxed">
